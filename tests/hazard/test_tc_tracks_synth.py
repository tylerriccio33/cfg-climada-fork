    ...
    def test_apply_decay_pass(self):
        ...
        p_ref = (
            np.array([
                ...
                0.974145711700000, 0.992440689170000, 1.000867294920000,
                1.005458533550000, 1.008183546090000, 1.009418500230000,
                1.009861920530000, 1.009984005650000,
            ])
            * 1e3
        )
        ...
        v_ref = (
            np.array([
                ...
                0.973796735300000, 0.687255951000000, 0.499485055600000,
                0.355148046200000, 0.227054803600000, 0.130209955700000,
                0.064538591800000, 0.022532585100000,
            ])
            * 1e2
        )
        # fmt: on
...
class TestSynth(unittest.TestCase):
    ...
    def test_random_walk_decay_pass(self):
        ...
        self.assertIn(
            "Decay parameters from category Hurricane Cat. 4 taken.", cm.output[5]
        )
        self.assertIn(
